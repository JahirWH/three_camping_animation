 import * as THREE from 'three';
        ...
        // Sin niebla para mayor claridad
        ...
        renderer.setClearColor(0x000000, 0); // Transparente total
        document.getElementById('canvas-container').appendChild(renderer.domElement);

        // Suelo invisible (solo para recibir sombras)
        const groundGeo = new THREE.CircleGeometry(15, 64);
        const groundMat = new THREE.ShadowMaterial({ 
            opacity: 0.3  // Sombras sutiles
        });
        ...
        window.addEventListener('mousemove', (event) => {
            ...
            // Pausar rotación automática al mover el mouse
            autoRotate = false;
        });

        // Reactivar rotación después de 3 segundos sin mover el mouse
        let mouseTimeout;
        ...
        // Animación
        let time = 0;
        const radius = 10; // Más cerca
        const rotationSpeed = 0.08; // Rotación suave
